        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between py-4">
                ...
                <div class="flex items-center space-x-5">
                    ...
                    <!-- User Account -->
                    <a href="/{{ \Unusualdope\FrontLaravelEcommerce\Models\UrlMapper::getFriendlyUrlForController(\Unusualdope\FrontLaravelEcommerce\Http\Controllers\Front\LoginController::class) ?: 'login' }}" class="hover:text-gray-600 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
